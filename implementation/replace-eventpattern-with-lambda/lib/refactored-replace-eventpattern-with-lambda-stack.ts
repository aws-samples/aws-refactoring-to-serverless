...
export class RefactoredReplaceEventpatternWithLambdaStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new cdk.CfnOutput(this, 'LambdaDestinationFunction1Name', {
      ...
      description: 'RefactoredEventDestinationFunction1',
    });
    new cdk.CfnOutput(this, 'LambdaDestinationFunction2Name', {
      value: lambdadestination_function_2.functionName,
      description: 'RefactoredEventDestinationFunction2',
    });
    new cdk.CfnOutput(this, 'EventFilterFunctionName', {
      value: event_filter_function.functionName,
      description: 'EventFilterFunctionName',
    });
  }
}
